                        ...
                        <div class="card card-primary card-outline card-outline-tabs">
                            ...
                            <div class="card-body card-article">
                                <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                    ...
                                    <div class="row">
                                        <?php if (isset($config['news'][$type]['range_start']) && $config['news'][$type]['range_start'] == true) { ?>
                                            <div class="form-group col-md-4">
                                                <label class="d-block" for="range_start">Giá đầu:</label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control format-price range_start text-sm" name="data[range_start]" id="range_start" placeholder="Giá đầu" value="<?= (!empty($flash->has('range_start'))) ? $flash->get('range_start') : @$item['range_start'] ?>">
                                        ...
                                        <?php } ?>
                                        <?php if (isset($config['news'][$type]['range_end']) && $config['news'][$type]['range_end'] == true) { ?>
                                            <div class="form-group col-md-4">
                                                <label class="d-block" for="range_end">Giá cuối:</label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control format-price range_end text-sm" name="data[range_end]" id="range_end" placeholder="Giá cuối" value="<?= (!empty($flash->has('range_end'))) ? $flash->get('range_end') : @$item['range_end'] ?>">
                                                    <div class="input-group-append">
                                                        <div class="input-group-text"><strong>VNĐ</strong></div>
                                                    </div>
                                                </div>
