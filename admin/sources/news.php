...
function saveMan()
{
    ...
    if ($data) {
        ...
        $data['range_start'] = (isset($data['range_start']) && $data['range_start'] != '') ? str_replace(",", "", $data['range_start']) : 0;
        $data['range_end'] = (isset($data['range_end']) && $data['range_end'] != '') ? str_replace(",", "", $data['range_end']) : 0;
        $data['type'] = $type;
    }
